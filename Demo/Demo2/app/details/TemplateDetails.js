  ...
  getDetailedCardTemplate({
    ...
    return `<div class="details-window">
        <div class="detailed-card text-center animated zoomIn">
            ...
            <h2 class='font-weight-bold capitalized-sentence'>${breed}</h2>
            <ul class="list-group">
                <ul class="list-group list-group-horizontal-md justify-content-around">
                    <ul class="list-group details-list__columns">
                        <li class="list-group-item font-italic details-card-info border border-secondary capitalized-sentence">Gender: ${gender}</li>
                        <li class="list-group-item font-italic details-card-info border border-secondary">Weight: ${weight} kg</li>
                        <li class="list-group-item font-italic details-card-info border border-secondary capitalized-sentence">Color: ${color}</li>
                        </ul>
                    <ul class="list-group details-list__columns">
                        <li class="list-group-item font-italic details-card-info border border-secondary">Birth date: ${birth_date}</li>
                        <li class="list-group-item font-italic details-card-info border border-secondary capitalized-sentence">Hair: ${hair}</li>
            ...
            <div class="card-footer d-md-flex flex-row justify-content-around">
                <button type="button" class="add-to-cart-btn btn-lg btn btn-success btn__border_round animated pulse infinite slower delay-5s my-1"
